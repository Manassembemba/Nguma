-- Force la recréation de la fonction et du trigger de notification par e-mail
-- pour s'assurer que la version correcte est appliquée sur la base de données distante.
-- Cela résout l'erreur persistante "schema "secrets" does not exist".
