-- Migration: Rétablissement de la fonction get_investor_list_details
-- Date: 2025-12-12
-- Description: Cette migration recrée la fonction `get_investor_list_details`, qui a été 
--              perdue ou n'a pas été correctement appliquée lors des migrations précédentes.
--              Ceci corrige l'erreur 404 Not Found (PGRST202) lors de l'accès à la liste des utilisateurs.
