-- This migration corrects the navigation link in the admin notification for new withdrawal requests.
-- The previous link was '/admin/pending-withdrawals', which was incorrect.
-- The correct route, as defined in App.tsx, is '/admin/withdrawals'.
...
BEGIN
    ...
    -- Notify admins about the new pending withdrawal with the CORRECT link
    PERFORM public.notify_all_admins(
        'Nouvelle demande de retrait en attente',
        '/admin/withdrawals', -- Corrected link
        _transaction_id
    );
